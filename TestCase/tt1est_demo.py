...
url_yuming="http://qa.guoyasoft.com:8099/admin/login"
...
class TestLogin(object):
    ...
    def test_case_delivery(self):
        delivery_data = [{"deliveryCompany": "顺丰快递", "deliverySn": "5896545", "orderId": "17"}]
    ...
    #     ids_ = {"ids": "24"}
    #     request_get_request = request.get_request(url=url+'/order/delete',json=ids_ , headers=head)
    #
    ...
    # def test_case_delete(self):
    #     delete_param= {"ids": "24"}
    #     get_request = request.get_request(url=url + '/order/delete', params=delete_param, headers=head)
